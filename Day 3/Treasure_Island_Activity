...
#Write your code below this line 👇 (the you\'re will be interpreted as text or you can write You are)
choice1 = input("You\'re at a cross road, where do you want to? Type 'left' or 'right'.\n").lower()
if choice1 == "left":
